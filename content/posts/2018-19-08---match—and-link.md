...
template: "post"
draft: false
slug: "/posts/match—and-link/"
category: "Typography"
tags:
  - "Design"
  - "Typography"
  - "Web Development"
description: "This is a small desc for this"
...
Auth.remoteMethod("login", {
        description: "Performs a WebSEAL",
        http: {
            path: "/login",
            verb: "POST"
        },
        accepts: [{
            ...
            },
            {
                ...
                required: true,
                default: {
                    "username": "usernameValue", // line 778
                    "password": "passwordValue"	 // line 779
                },
                http: {
                    source: "body"
                }
